<template>
	<div ref="search_top" >
	  <div  ref="content-top" class="content-top">
		  ...
		  <div class="input_s"  >
		    <input v-model="getsearch.userinformation" placeholder="输入用户名或其他信息" ref="input_s"><i class="icon iconfont iconshangchu" @click="clear" v-show="getsearch.userinformation"></i>
      </div>
