  ...
  <div ref="realnamepage" class="realnamepage">
    ...
    <div class="content-middle">
      <div class="price-list">
        <li>
          <div class="property">地点</div>
          <span>某某市某区XXX酒店</span>
        </li>
        <li>
          <div class="property">人数</div>
          <span>50</span>~<span>100</span>
        </li>
        <li>
          <div class="property">时间</div>
          <span>2020.04.30</span><span>星期六下午两点</span>
        </li>
        <li>
          <div class="property">内容</div>
          <span>吃甜点的休闲，与心仪者聊天，可赠鲜花表明爱意</span>
        </li>
      </div>
